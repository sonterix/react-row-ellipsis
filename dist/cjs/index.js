...
var Ellipsis = function (_a) {
    var lines = _a.lines, style = _a.style, children = _a.children, props = __rest(_a, ["lines", "style", "children"]);
    var customStyles = __assign(__assign({}, (style || {})), { display: '-webkit-box', WebkitLineClamp: lines, WebkitBoxOrient: 'vertical', overflow: 'hidden', textOverflow: 'ellipsis' });
    return (jsxRuntime.exports.jsx("p", __assign({ style: customStyles }, props, { children: children })));
};
